...
public class BluetoothChatService {
        ...
        public ConnectThread(BluetoothDevice device, boolean secure) {
            ...
            try {
                ...
                for (int i = 0; i < uuids.length; i++) {
                    Log.d(TAG, device.getName() + "uuid" + i + ":" + uuids[i].toString());
                }
                //MY_UUID_INSECURE = uuids[0].getUuid();
                //MY_UUID_SECURE = uuids[0].getUuid();
                if (secure) {
    ...
    private class ConnectedThread extends Thread {
        ...
        private final byte[] LRLF = {0x0d, 0x0a};
        ...
        public void run() {
            ...
            while (mState == STATE_CONNECTED) {
                try {
                    ...
                    mHandler.obtainMessage(Constants.MESSAGE_READ, line.length(), -1, line)
                            .sendToTarget();
                } catch (IOException e) {
